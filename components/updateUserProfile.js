const home = document.getElementById("updateUserProfile");
const container = document.createElement("div");

container.className = "container";
container.innerHTML = `
<body>
    <form class="formTable" action="http://localhost:8080/Fuel-Tracking-Application/server/userProfileUpdate.php" method="POST">
