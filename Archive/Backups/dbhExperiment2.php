...
$stmt = $conn->prepare("INSERT INTO ClientInformation (email, password, fname, lname, phone, zipcode, companyName, companyState, companyCity, companyStreet)
                       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

$stmt->bind_param("ssssssssss", $email, $password, $fname, $lname, $phone, $zipcode, $companyName, $companyState, $companyCity, $companyStreet);
